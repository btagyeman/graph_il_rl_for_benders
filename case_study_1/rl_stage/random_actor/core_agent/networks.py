...
x_mean = np.load("parameter_verification/x_mean.npy")
x_std = np.load("parameter_verification/x_std.npy")

e_mean = np.load("parameter_verification/e_mean.npy")
e_std = np.load("parameter_verification/e_std.npy")
