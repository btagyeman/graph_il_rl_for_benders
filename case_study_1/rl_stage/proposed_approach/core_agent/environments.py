...
class GBDENV:
    def __init__(self, UBD, LBD, feas_pars, x_guess, y_guess, epsilon=0.001, max_iter=100):
    ...
    def compute_rewards(self):
        ...
        total_reward = 4*self.reward_bnds - 4*self.reward_il + 1*self.reward_time + self.reward_infs_mp
