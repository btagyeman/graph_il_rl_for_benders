...
# Folder paths
folder_path = './raw_info_demo_farm'
folder_path_final = './seasonal_weather_data_demo_farm'


# # Folder paths
# folder_path = './raw_info_edmonton'
# folder_path_final = './seasonal_weather_data_edmonton'

# # Folder paths
# folder_path = './raw_info_three_hills'
# folder_path_final = './seasonal_weather_data_three_hills'

# # Folder paths
# folder_path = './raw_info_leth_cda'
# folder_path_final = './seasonal_weather_data_leth_cda'
