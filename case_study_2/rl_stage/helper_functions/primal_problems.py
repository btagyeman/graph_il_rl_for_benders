...
import numpy as np 
from trained_lstm_models.lstm_mz1 import optimizeInputModel_automated_mz1

def initial_subproblem(self):
    w = []
    J = 0
    lbw = []
    ubw = []
    ...
    if solver_status == 'Solve_Succeeded':
        ...
        self.u_guess = self.obtain_irrig_amount(opt_vals,5) 
        self.x_guess = self.obtain_soil_moisture(opt_vals,5)[0]
