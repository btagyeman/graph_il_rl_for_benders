...
def run_irrigation_scheduler(self, k):
    ...
    states_mz1,irrigAmnts_mz1,irrigDecs,ubd_final,lbd_final,optimal_values,graph_features,cut_order=run_gbd_for_scheduler(x0_scaled_mz1,u_init_mz1,self.guessesX,self.guessesU,self.guessesC,
