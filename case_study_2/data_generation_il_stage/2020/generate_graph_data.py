...
print("Running the season long simulation to generate the dataset for year 2020...")
dataset_a = GenerateDataset()
dataset_a.plot_trajectory()
with open("./gbd_datasets/graph_gbd_dataset_scheduler_2020.pkl", "wb") as f_a:
    pickle.dump(dataset_a.graphs, f_a)
    pass 
print("Dataset generated and saved as   'graph_gbd_dataset_scheduler_2020.pkl'")