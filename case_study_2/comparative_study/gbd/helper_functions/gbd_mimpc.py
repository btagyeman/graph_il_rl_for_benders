...
def run_gbd_for_scheduler(x0_scaled_mz1, u_init_mz1,guessesX,guessesU,guessesC,
    ...
    gbd_instance.solve_subproblem(stage='Final Step')
    print("Final irrigation decisions", gbd_instance.c)
    return gbd_instance.x,gbd_instance.u,gbd_instance.c,gbd_instance.ubd,gbd_instance.lbd,gbd_instance.optimal_values,gbd_instance.graph_features,gbd_instance.cut_order,eval_time_mp, mp_count