...
#Layer 1
W_1 = np.loadtxt("./trained_lstm_models/model_weights/K_1_mz2_vrd_lai.txt")
U_1 = np.loadtxt("./trained_lstm_models/model_weights/RK_1_mz2_vrd_lai.txt")
b_1 = np.loadtxt("./trained_lstm_models/model_weights/BR_1_mz2_vrd_lai.txt")
#Layer 2
W_2 = np.loadtxt("./trained_lstm_models/model_weights/K_2_mz2_vrd_lai.txt")
U_2 = np.loadtxt("./trained_lstm_models/model_weights/RK_2_mz2_vrd_lai.txt")
b_2 = np.loadtxt("./trained_lstm_models/model_weights/BR_2_mz2_vrd_lai.txt")
#Dense layer
V_m = np.loadtxt("./trained_lstm_models/model_weights/KD_mz2_vrd_lai.txt")
b_m = np.loadtxt("./trained_lstm_models/model_weights/BD_mz2_vrd_lai.txt")
...
def optimizeInputModel_automated_mz2(pressureHeads,irrigationAmounts,cropCoefficient, referenceET, rooting_depth, lai_factor):
...
def getRNNmodel_numpy_mz2(pressureHead, irrigationAmount, cropCoefficient, referenceET, rooting_depth, lai_factor):
